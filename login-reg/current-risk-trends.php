...
<body>
    ...
    <script>
        ...
        // Add event listener for clicking on chart segments
        myPieChart.options.onClick = function(event, elements) {
            if (elements && elements.length > 0) {
                var riskLabel = myPieChart.data.labels[elements[0].index];
                window.location.href = 'risk-controls.php?risk=' + riskLabel;
            }
        };
    </script>
</body>
