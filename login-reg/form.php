...
<script>
    function showRiskMapping() {
        ...
        if (category === "Physical and Environmental Security") {
            ...
            addOption(riskMappingDropdown, "Weak Encryption Algorithms");
            addOption(riskMappingDropdown, "Unauthenticated Encryption");
            addOption(riskMappingDropdown, "Insecure Key Management");
            addOption(riskMappingDropdown, "Lack of Secure Communication Protocols");
        } else {
